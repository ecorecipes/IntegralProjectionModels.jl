...
2. Three correction methods: `NoCorrection`, `TruncatedDistributions`, `DiscreteExtrema`
...
println("  Discrete extrema:        ", round(λ_extrema - λ_nocorr, sigdigits=4))
```
